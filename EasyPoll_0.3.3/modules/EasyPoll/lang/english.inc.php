...
<p>EasyPoll Manager was successfully installed. You may now delete the <strong>setup.sql</strong> file from your
server. File path: %s</p>';
...
$_lang['EP_lang_text']
= 'Add, remove or change Languages you want to create Polls for.<br/>Please note that you must supply all Poll-questions
and answers in every language you create here.';
$_lang['EP_lang_short'] = 'Language Code (1-3 letters)';
$_lang['EP_lang_long'] = 'Language Name';
$_lang['EP_lang_del']
= 'Do you really want to delete the Language \'%s\'? <strong>Please note, that this action will delete all Poll and
...
$_lang['EP_polls_text']
= 'Add, remove or change Polls<br/><strong>T</strong> = Translation Status (roll over icon to see details).
